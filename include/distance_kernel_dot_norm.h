...
inline float dot_norm_dist(const float* q, const float* v,
                           uint32_t d, float q_norm_sq, float v_norm_sq) {
...
inline void dot_norm_dist_batch_4(
        const float* q,
        const float* v0, const float* v1,
        const float* v2, const float* v3,
        uint32_t d,
        float q_norm_sq,
        float vn0, float vn1, float vn2, float vn3,
    ...
    if (dis0 < 0.0f) dis0 = 0.0f;
    if (dis1 < 0.0f) dis1 = 0.0f;
    if (dis2 < 0.0f) dis2 = 0.0f;
    if (dis3 < 0.0f) dis3 = 0.0f;
}
...
inline void dot_norm_dist_batch_2(
        const float* q,
        const float* v0, const float* v1,
        uint32_t d,
        float q_norm_sq,
...
inline void dot_norm_dist_batch_3(
        const float* q,
