...
// ============================================================
// FaissExtractor — convert faiss IndexHNSWFlat to flat shm buffer
// ============================================================
...
public:
    ...
    static std::vector<std::vector<char>> extract_sharded(
    ...
    static std::vector<std::vector<char>> build_and_extract_sharded(
            ...
            std::vector<uint32_t>* new_to_old_idmap = nullptr,
